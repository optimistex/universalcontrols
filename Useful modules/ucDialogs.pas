...
{$IF DEFINED(LINUX)}
  WinUtils,
{$IFEND}
  Windows, Messages, SysUtils, CommDlg, Printers,
  Classes, Graphics, Controls, Forms, StdCtrls,
  ShlObj, CommCtrl, ComCtrls;
...
(*$HPPEMIT '  #pragma alias "@Dialogs@TSaveDialog@Execute$qqrpv"="@Dialogs@TSaveDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TColorDialog@Execute$qqrpv"="@Dialogs@TColorDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TPrintDialog@Execute$qqrpv"="@Dialogs@TPrintDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TFindDialog@Execute$qqrpv"="@Dialogs@TFindDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TPageSetupDialog@Execute$qqrpv"="@Dialogs@TPageSetupDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TFontDialog@Execute$qqrpv"="@Dialogs@TFontDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TCommonDialog@Execute$qqrpv"="@Dialogs@TCommonDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TOpenDialog@Execute$qqrpv"="@Dialogs@TOpenDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '  #pragma alias "@Dialogs@TPrinterSetupDialog@Execute$qqrpv"="@Dialogs@TPrinterSetupDialog@Execute$qqrp6HWND__"' *)
(*$HPPEMIT '#endif' *)
...
{$IF DEFINED(CLR)}
    ...
    FTemplate: string;
//TODO: Merge: Introduce for WIN32 and adjust all assignments of DialogHook
...
{$IF DEFINED(MSWINDOWS)}
  WideStrUtils,
{$IFEND}
  ExtCtrls, UcConsts, Dlgs, Math, Themes, ActiveX, StrUtils, MultiMon, HelpIntfs;
...
begin
  if (Win32MajorVersion >= 6) and UseLatestCommonDialogs and (Template = '') and
